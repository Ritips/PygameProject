...
player_images = {
    ...
    'back_right_leg': front_right_leg,
    'front_left_leg': front_left_leg,
    'side_left_leg': side_left_leg,
    'side_right_leg_reverse': side_right_leg,
    'side_stay_reverse': side_stay,
    'back_stay': back_stay,
    ...
    'side_right_leg': pygame.transform.flip(side_right_leg, True, False),
    'side_stay': pygame.transform.flip(side_stay, True, False),

    'side_stay_push1_reverse': side_stay_push1,
    'side_stay_push2_reverse': side_stay_push2,
    'side_stay_push1': pygame.transform.flip(side_stay_push1, True, False),
    'side_stay_push2': pygame.transform.flip(side_stay_push2, True, False),
